...
from config.main import SHOP_ID, PAYMENT_TOKEN, RETURN_URL
...
async def create_payment_link(sub_id, user_id, subscription_end, email):
...
async def create_recurring_payment(sub_id, user_id, subscription_end, email, payment_token):
